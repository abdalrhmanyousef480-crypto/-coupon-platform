...
async function main() {
  ...
  const categoriesData = [
    { name: "Fashion", nameAr: "أزياء", slug: "fashion", icon: "shirt",
    ...
    { name: "Electronics", nameAr: "إلكترونيات", slug: "electronics", icon: "cpu",
    ...
    { name: "Travel", nameAr: "سفر", slug: "travel", icon: "plane",
