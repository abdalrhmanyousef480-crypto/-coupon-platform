...
export const STRINGS = {
  ar: {
    ...
    "coupon.viewDetails": "تفاصيل الكوبون وطريقة الاستخدام",
  ...
  en: {
    ...
    "coupon.viewDetails": "Coupon details & how to use",
